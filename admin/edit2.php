...
<div class="container mt-5">
    ...
    <?php
    // Check if the 'reg_no' parameter is set in the URL
    ...
    if (!$record) {
        ...
        <form action="update2.php" method="post">
            <input type="hidden" name="reg_no" value="<?php echo $record['REG_NO']; ?>">
            <div class="mb-3">
                <label for="sn" class="form-label">Serial Number (SN)</label>
                <input type="number" class="form-control" id="sn" name="sn" value="<?php echo $record['SN']; ?>" required>
            </div>
            <div class="mb-3">
